...
def get_stock_data(symbol, time_range="5y"):
    ...
    service_context = ServiceContext.from_defaults(llm=OpenAI(
        ...
        system_prompt="You are an expert on the Data Analysis and your job is to answer analytical questions. Assume that all questions are related to dataset provided. Keep your answers technical and based on facts – do not hallucinate features."))
...
def app():
    ...
    st.sidebar.info(
        'Created by Cameron Jones, view the Source Code on [GitHub](https://github.com/cameronjoejones/streamlit-kpi-dashboard)')
